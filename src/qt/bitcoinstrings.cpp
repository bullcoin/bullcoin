...
QT_TRANSLATE_NOOP("quark-core", "Bullcoin version"),
...
QT_TRANSLATE_NOOP("quark-core", "Error loading wallet.dat: Wallet requires newer version of Bullcoin"),
...
QT_TRANSLATE_NOOP("quark-core", "SSL options: (see the Bullcoin Wiki for SSL setup instructions)"),
...
QT_TRANSLATE_NOOP("quark-core", "Specify configuration file (default: bullcoin.conf)"),
...
QT_TRANSLATE_NOOP("quark-core", "Specify pid file (default: bullcoind.pid)"),
...
QT_TRANSLATE_NOOP("quark-core", "Wallet needed to be rewritten: restart Bullcoin to complete"),
