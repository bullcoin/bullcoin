...
// Copyright (c) 2013 The Bullcoin developers
...
uint256 hashGenesisBlock("0x00000d32924a13dd912b58d54f94c90e8aa1e9f263b277613d3716d1a5497295");
static const unsigned int timeGenesisBlock = 1389429821;
...
static const int64 nBlockRewardStartCoin = 1000 * COIN;
static const int64 nBlockRewardMinimumCoin = 1 * COIN;

static const int64 nTargetTimespan = 500 * 60; // 500 minutes
static const int64 nTargetSpacing = 30; // 30 seconds
static const int64 nInterval = nTargetTimespan / nTargetSpacing; // 1000 blocks
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "THE BULL COIN";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x14bdc407217a9dd9b35e76fd1ef8cfeb4c2465806d0e09fed661171c20b61592"));
